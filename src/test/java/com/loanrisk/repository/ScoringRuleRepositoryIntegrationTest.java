...
public class ScoringRuleRepositoryIntegrationTest {
    ...
    public void whenFindEnabledOrderByPriority_thenCorrectRulesAreReturned() {
        // These rules are now loaded from data.sql
        ...
        assertThat(enabledRules).hasSize(6); // Expecting 6 rules from data.sql
        assertThat(enabledRules.get(0).getName()).isEqualTo("Credit too low");
        assertThat(enabledRules.get(1).getName()).isEqualTo("Credit average");
        assertThat(enabledRules.get(2).getName()).isEqualTo("Loan-to-income high");
        assertThat(enabledRules.get(3).getName()).isEqualTo("Debt is high");
        assertThat(enabledRules.get(4).getName()).isEqualTo("Too young");
        assertThat(enabledRules.get(5).getName()).isEqualTo("Vacation loan");
    }
